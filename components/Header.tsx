function Header() {
  ...
  <div className="flex flex-col items-center justify-between p-4">
    ...
    <p className="m-4 ext-lg text-center font-normal text-gray-500 lg:text-xl dark:text-gray-400">Hola soy Michel Haussaire un desarrollador argentino, apacionado por transformar ideas en código, construyendo experiencias web y aplicaciones que impulsen el progreso.</p>
